...
// });
    ...
    Route::post('/',[AdminController::class,'index']);
        ...
        Route::group(['middleware'=>['protectedPage']],function(){
            ...
            Route::get('admin/attendance/attendance-ajax',[AttendanceController::class,'ajax_attendance']);
            Route::post('admin/attendance-filter',[AttendanceController::class,'filter_attendance']);
            Route::resource('admin/attendance',AttendanceController::class);
            Route::post('admin/department-designations',[EmployeeController::class,'department_designations']);
            ...
            Route::post('admin/change-leave-status',[LeaveApplicationController::class,'changeLeave_status']);
        ...
        Route::get('employee/leave/{id}',[LeaveApplicationController::class,'getSingle_leave']);
        Route::post('employee/login',[EmployeeController::class,'login']);
    
        Route::group(['middleware'=>['empprotectedPage']],function(){
            Route::get('employee/home',[EmployeeController::class,'profile']);
            Route::get('employee/leaves',[EmployeeController::class,'my_leaves']); 
            Route::post('employee/employee-leave',[EmployeeController::class,'add_leave']); 
            Route::get('employee/my-leaves',[LeaveApplicationController::class,'view']);
