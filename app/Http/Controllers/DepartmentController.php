...
class DepartmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        //
        if ($request->ajax()) {
            $data = Department::latest()->orderBy('department_id','desc')->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        $Departments = Department::where(['department_id'=>$id])->update([
    ...
    {
        $employee = Employee::where('emp_department','=',$id)->first();
        if($employee === null){
            $destroy = Department::where('department_id',$id)->delete();
            return  $destroy;
        }else{ 
