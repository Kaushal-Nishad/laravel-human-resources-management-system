...
class ExpenseController extends Controller
{
    ...
    public function index(Request $request)
    {
        //
        if ($request->ajax()) {
            $currency = DB::table('settings')->first()->cur_format;

            $data = Expense::orderBy('expenses_id','desc')->get();
    ...
    {
        //
        $Expenses = Expense::where(['expenses_id'=>$id])->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        $Expenses = Expense::where(['expenses_id'=>$id])->update([
    ...
    {
        //
        $destroy = Expense::where('expenses_id',$id)->delete();
        return  $destroy;
    }
}
